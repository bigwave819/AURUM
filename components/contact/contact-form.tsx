...
export function ContactForm() {
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    // wire to a server action here, e.g. sendContactMessage(values)
    setSent(true);
      ...
      <form onSubmit={handleSubmit}>
        <motion.div variants={fieldVariants} className="mb-5">
          ...
          <input
            ...
            className="w-full bg-transparent outline-none text-[14.5px] py-2"
        ...
        <motion.div variants={fieldVariants} className="mb-5">
          ...
          <textarea
            ...
            className="w-full bg-transparent outline-none text-[14.5px] py-2 resize-none"
            style={{ borderBottom: "1px solid #E0D5C8", color: "#3A2F22" }}
            onFocus={(e) => (e.currentTarget.style.borderColor = "#745A27")}
            onBlur={(e) => (e.currentTarget.style.borderColor = "#E0D5C8")}
          />
        ...
        <motion.button
          ...
          type="submit"
          whileTap={{ scale: 0.98 }}
          className="w-full py-3.5 mt-2 text-[12.5px] tracking-wide uppercase rounded-md transition-colors"
          style={{
            backgroundColor: sent ? "#3B6D11" : "#745A27",
            color: "#FFF8F3",
          }}
        >
